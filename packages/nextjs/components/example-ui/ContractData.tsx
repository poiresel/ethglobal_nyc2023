...
export const ContractData = () => {
  ...
  const { data: currentGreeting, isLoading: isGreetingLoading } = useScaffoldContractRead({
    contractName: "SloganProposal",
    functionName: "hoaSlogan",
  });

  useScaffoldEventSubscriber({
    contractName: "SloganProposal",
    eventName: "SloganChange",
    listener: logs => {
      logs.map(log => {
        const { initiator, newGreeting } = log.args;
        console.log("📡 SloganChange event", initiator, newGreeting);
      });
    },
  });
